...
Fedora-Fr)](https://www.borsalinux-fr.org). Il génère une fiche de membre qui
peut être vide ou pré-remplie avec les informations d'un adhérent (à joindre à
un chèque pour une inscription par exemple).

**Note** : depuis Galette `0.8.3`, une fiche membre PDF basée sur les modèles
est fournie. Installer Fullcard `1.6` ou plus récent remplacera ce modèle.
...
depuis l'[interface de gestion des plugins de
...
connexion, ce qui en fait un formulaire papier distribuable lors d'un événement.
...
un contrôle total, au prix d'une modification de PHP. Si vos changements peuvent
servir à d'autres, [ouvrez une pull
