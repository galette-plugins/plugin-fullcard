...
[Borsalinux-fr (previously Fedora-Fr)](https://www.borsalinux-fr.org). The card
it produces can be printed empty, to be filled in by hand during an event, or
pre-filled with a member's information — handy to join to a cheque for a
membership renewal.
...
* or using the [source code from the repository](https://github.com/galette-plugins/plugin-fullcard),
