...
இந்தச் சொருகி [போர்சலினக்ச்-எஃப்ஆர் (முன்னர் ஃபெடோரா-எஃப்ஆர்)](https://www.borsalinux-fr.org) க்கு உருவாக்கப்பட்டது. இது ஒரு PDF உறுப்பினர் அட்டையை உருவாக்குகிறது (நிகழ்வுகளின்போது பயன்படுத்தப்பட வேண்டும்) அல்லது உறுப்பினர் தகவல்களால் நிரப்பப்படுகிறது (இது ஒரு உறுப்பினர் காசோலையுடன் எடுத்துக்காட்டாக இணைக்கப்படலாம்).

**Note**: கலெட் `0.8.3` என்பதால், PDF மாதிரிகளை அடிப்படையாகக் கொண்ட PDF உறுப்பினர் அட்டை வழங்கப்படுகிறது. ஃபுல் கார்டை நிறுவுவது `1.6` அல்லது புதியது இந்த மாதிரியை மாற்றும்.
...
பதிவிறக்கம் செய்யப்பட்ட காப்பகத்தைக் கேலட் `plugins` கோப்பகத்தில் பிரித்தெடுக்கவும். எடுத்துக்காட்டாக, லினக்சின் கீழ் (`{url}` மற்றும் `{version}` ஆகியவற்றை சரியான மதிப்புகளுடன் மாற்றுகிறது):
